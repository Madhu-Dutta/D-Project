...
class ResourcesResearch extends React.Component {
    getCarbonFootprint = () => {
        ...
        return (
            ...
            <div className="container-wrapper">
                        ...
                        <div className="col-lg-4 thumbnail" style={{ padding: "3%" }}>
                            ...
                            <ToggleArrow>
                                ...
                                Magawatts of wasted energy are central to its delivery.</p>
                                    ...
                                    <Button color="success" onClick={this.getCarbonFootprint}>Find how to calculate your carbon footprint</Button>
                                </div>
                            </ToggleArrow>
                        </div>
                        <div className="col-lg-4 thumbnail" style={{ padding: "3%" }}>
                        ...
                        <div className="col-lg-4 thumbnail" style={{ padding: "3%" }}>
                            ...
                            <ToggleArrow>
                                ...
                                Magawatts of wasted energy are central to its delivery.</p>
                                    ...
                                    centre(65% of all Australian/NewZealand(ANZ)
                                dialysis), or in home( 35% of all ANZ dialysis). </p>
                                    <Button color="success" onClick={this.getWater}>Find out your water usage</Button>
                                </div>
                            </ToggleArrow>
                        </div>
                        <div className="col-lg-4 thumbnail" style={{ padding: "3%" }}>
                ...
                <div className="midlayer py-5 mid-grid" style={{ backgroundColor: "#EFEFEF" }}>
                    ...
                    <div><img src={arrows} onClick={this.getTracking} alt="link to page" /></div>
                </div>
